...
public class MainActivity extends ActionBarActivity implements View.OnClickListener
{
    ...
    ArrayList<EmployeeDetail> arrayList = new ArrayList<>();
    ...
    private void iniComponent()
    {
        ...
        EmployeeDetail model2 = new EmployeeDetail();

        model2.setName("bhavik");
        model2.setAge(20);
        model2.setCity("abcd");
        model2.setSalary(10000);
        ...
        for (int i=0;i<5;i++){
            ...
            EmployeeDetail pojo = new EmployeeDetail();

            pojo.setName("bhavik"+i);
            pojo.setAge(20+i);
            pojo.setCity("city"+i);
            pojo.setSalary(10000+i);
